...
# lbody_fab
App.ActiveDocument.Spreadsheet.set('A1', 'var lbody_fab = '); App.ActiveDocument.Spreadsheet.set('B1', '1.75'); App.ActiveDocument.Spreadsheet.setAlias('B1', 'lbody_fab')
# tbody_fab
...
# clbody_fab
App.ActiveDocument.Spreadsheet.set('A5', 'var clbody_fab = '); App.ActiveDocument.Spreadsheet.set('B5', '12.55'); App.ActiveDocument.Spreadsheet.setAlias('B5', 'clbody_fab')
# ctbody_fab
...
# cdbody_fab
App.ActiveDocument.Spreadsheet.set('A7', 'var cdbody_fab = '); App.ActiveDocument.Spreadsheet.set('B7', '16.9'); App.ActiveDocument.Spreadsheet.setAlias('B7', 'cdbody_fab')
# dscrew
...
# rmx
App.ActiveDocument.Spreadsheet.set('A10', 'var rmx = '); App.ActiveDocument.Spreadsheet.set('B10', '5.0'); App.ActiveDocument.Spreadsheet.setAlias('B10', 'rmx')
# rmy
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Omeg_PC16BU_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Omeg_PC16BU_Vertical.FCStd")
print("created Potentiometer_Omeg_PC16BU_Vertical")
...
App.ActiveDocument.clearAll()
# lbody_fab
App.ActiveDocument.Spreadsheet.set('A1', 'var lbody_fab = '); App.ActiveDocument.Spreadsheet.set('B1', '0.75'); App.ActiveDocument.Spreadsheet.setAlias('B1', 'lbody_fab')
# tbody_fab
...
# wbody_fab
App.ActiveDocument.Spreadsheet.set('A3', 'var wbody_fab = '); App.ActiveDocument.Spreadsheet.set('B3', '12.7'); App.ActiveDocument.Spreadsheet.setAlias('B3', 'wbody_fab')
# hbody_fab
...
# clbody_fab
App.ActiveDocument.Spreadsheet.set('A5', 'var clbody_fab = '); App.ActiveDocument.Spreadsheet.set('B5', '7.1'); App.ActiveDocument.Spreadsheet.setAlias('B5', 'clbody_fab')
# ctbody_fab
...
# dscrew
App.ActiveDocument.Spreadsheet.set('A8', 'var dscrew = '); App.ActiveDocument.Spreadsheet.set('B8', '9.524999999999999'); App.ActiveDocument.Spreadsheet.setAlias('B8', 'dscrew')
# dshaft
App.ActiveDocument.Spreadsheet.set('A9', 'var dshaft = '); App.ActiveDocument.Spreadsheet.set('B9', '6.35'); App.ActiveDocument.Spreadsheet.setAlias('B9', 'dshaft')
# rmx
App.ActiveDocument.Spreadsheet.set('A10', 'var rmx = '); App.ActiveDocument.Spreadsheet.set('B10', '7.62'); App.ActiveDocument.Spreadsheet.setAlias('B10', 'rmx')
# rmy
...
# height
App.ActiveDocument.Spreadsheet.set('A15', 'var height = '); App.ActiveDocument.Spreadsheet.set('B15', '13.1'); App.ActiveDocument.Spreadsheet.setAlias('B15', 'height')
# mh_rmx
App.ActiveDocument.Spreadsheet.set('A16', 'var mh_rmx = '); App.ActiveDocument.Spreadsheet.set('B16', '0'); App.ActiveDocument.Spreadsheet.setAlias('B16', 'mh_rmx')
# mh_rmy
App.ActiveDocument.Spreadsheet.set('A17', 'var mh_rmy = '); App.ActiveDocument.Spreadsheet.set('B17', '15'); App.ActiveDocument.Spreadsheet.setAlias('B17', 'mh_rmy')
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Vishay_248GJ-249GJ_Single_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Vishay_248GJ-249GJ_Single_Vertical.FCStd")
print("created Potentiometer_Vishay_248GJ-249GJ_Single_Vertical")
...
App.ActiveDocument.Spreadsheet.set('A2', 'var tbody_fab = '); App.ActiveDocument.Spreadsheet.set('B2', '-8.79'); App.ActiveDocument.Spreadsheet.setAlias('B2', 'tbody_fab')
# wbody_fab
App.ActiveDocument.Spreadsheet.set('A3', 'var wbody_fab = '); App.ActiveDocument.Spreadsheet.set('B3', '12.5'); App.ActiveDocument.Spreadsheet.setAlias('B3', 'wbody_fab')
# hbody_fab
App.ActiveDocument.Spreadsheet.set('A4', 'var hbody_fab = '); App.ActiveDocument.Spreadsheet.set('B4', '12.5'); App.ActiveDocument.Spreadsheet.setAlias('B4', 'hbody_fab')
# clbody_fab
App.ActiveDocument.Spreadsheet.set('A5', 'var clbody_fab = '); App.ActiveDocument.Spreadsheet.set('B5', '7.0'); App.ActiveDocument.Spreadsheet.setAlias('B5', 'clbody_fab')
# ctbody_fab
App.ActiveDocument.Spreadsheet.set('A6', 'var ctbody_fab = '); App.ActiveDocument.Spreadsheet.set('B6', '-2.54'); App.ActiveDocument.Spreadsheet.setAlias('B6', 'ctbody_fab')
# cdbody_fab
App.ActiveDocument.Spreadsheet.set('A7', 'var cdbody_fab = '); App.ActiveDocument.Spreadsheet.set('B7', '0'); App.ActiveDocument.Spreadsheet.setAlias('B7', 'cdbody_fab')
# dscrew
App.ActiveDocument.Spreadsheet.set('A8', 'var dscrew = '); App.ActiveDocument.Spreadsheet.set('B8', '6.35'); App.ActiveDocument.Spreadsheet.setAlias('B8', 'dscrew')
# dshaft
App.ActiveDocument.Spreadsheet.set('A9', 'var dshaft = '); App.ActiveDocument.Spreadsheet.set('B9', '3.17'); App.ActiveDocument.Spreadsheet.setAlias('B9', 'dshaft')
# rmx
App.ActiveDocument.Spreadsheet.set('A10', 'var rmx = '); App.ActiveDocument.Spreadsheet.set('B10', '7.62'); App.ActiveDocument.Spreadsheet.setAlias('B10', 'rmx')
# rmy
App.ActiveDocument.Spreadsheet.set('A11', 'var rmy = '); App.ActiveDocument.Spreadsheet.set('B11', '2.54'); App.ActiveDocument.Spreadsheet.setAlias('B11', 'rmy')
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Vishay_148-149_Single_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Vishay_148-149_Single_Vertical.FCStd")
print("created Potentiometer_Vishay_148-149_Single_Vertical")
...
# wbody_fab
App.ActiveDocument.Spreadsheet.set('A3', 'var wbody_fab = '); App.ActiveDocument.Spreadsheet.set('B3', '18.0'); App.ActiveDocument.Spreadsheet.setAlias('B3', 'wbody_fab')
# hbody_fab
...
# clbody_fab
App.ActiveDocument.Spreadsheet.set('A5', 'var clbody_fab = '); App.ActiveDocument.Spreadsheet.set('B5', '10.5'); App.ActiveDocument.Spreadsheet.setAlias('B5', 'clbody_fab')
# ctbody_fab
App.ActiveDocument.Spreadsheet.set('A6', 'var ctbody_fab = '); App.ActiveDocument.Spreadsheet.set('B6', '-5.0'); App.ActiveDocument.Spreadsheet.setAlias('B6', 'ctbody_fab')
# cdbody_fab
App.ActiveDocument.Spreadsheet.set('A7', 'var cdbody_fab = '); App.ActiveDocument.Spreadsheet.set('B7', '0'); App.ActiveDocument.Spreadsheet.setAlias('B7', 'cdbody_fab')
# dscrew
App.ActiveDocument.Spreadsheet.set('A8', 'var dscrew = '); App.ActiveDocument.Spreadsheet.set('B8', '10'); App.ActiveDocument.Spreadsheet.setAlias('B8', 'dscrew')
# dshaft
...
App.ActiveDocument.Spreadsheet.set('A14', 'var d_wire = '); App.ActiveDocument.Spreadsheet.set('B14', '1.0'); App.ActiveDocument.Spreadsheet.setAlias('B14', 'd_wire')
# height
App.ActiveDocument.Spreadsheet.set('A15', 'var height = '); App.ActiveDocument.Spreadsheet.set('B15', '20.5'); App.ActiveDocument.Spreadsheet.setAlias('B15', 'height')
# mh_rmx
App.ActiveDocument.Spreadsheet.set('A16', 'var mh_rmx = '); App.ActiveDocument.Spreadsheet.set('B16', '0'); App.ActiveDocument.Spreadsheet.setAlias('B16', 'mh_rmx')
# mh_rmy
App.ActiveDocument.Spreadsheet.set('A17', 'var mh_rmy = '); App.ActiveDocument.Spreadsheet.set('B17', '15'); App.ActiveDocument.Spreadsheet.setAlias('B17', 'mh_rmy')
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PC-16_Single_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PC-16_Single_Vertical.FCStd")
print("created Potentiometer_Piher_PC-16_Single_Vertical")
