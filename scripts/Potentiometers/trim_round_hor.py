...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-6-V_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-6-V_Vertical.FCStd")
print("created Potentiometer_Piher_PT-6-V_Vertical")
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-10-V10_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-10-V10_Vertical.FCStd")
print("created Potentiometer_Piher_PT-10-V10_Vertical")
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-15-V02_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-15-V02_Vertical.FCStd")
print("created Potentiometer_Piher_PT-15-V02_Vertical")
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-15-V15_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_Piher_PT-15-V15_Vertical.FCStd")
print("created Potentiometer_Piher_PT-15-V15_Vertical")
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_ACP_CA9-V10_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_ACP_CA9-V10_Vertical.FCStd")
print("created Potentiometer_ACP_CA9-V10_Vertical")
...
FreeCADGui.export(__objs__,os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_ACP_CA14V-15_Vertical.wrl")
doc.saveCopy(os.path.split(doc.FileName)[0]+os.sep+"Potentiometer_ACP_CA14V-15_Vertical.FCStd")
print("created Potentiometer_ACP_CA14V-15_Vertical")
